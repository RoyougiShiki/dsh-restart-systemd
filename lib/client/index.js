...
var PENDING_TIMEOUT_MS = 45e3;
var RESULT_DISMISS_MS = 6e3;
function restartReloadDecision(state, flags) {
...
function RestartButton({ wide, useConnectionState, t }) {
  ...
  const actionsRef = (0, import_react.useRef)({ close: () => {
  }, confirm: () => {
  } });
  const scheduledRef = (0, import_react.useRef)(false);
  const sawOutageRef = (0, import_react.useRef)(false);
  ...
  (0, import_react.useEffect)(() => {
    if (phase.kind !== "pending") return void 0;
  ...
  const trigger = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "button",
    {
      ...
      children: pending ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SpinnerGlyph, { size: wide ? 16 : 18 }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RestartGlyph, { size: wide ? 16 : 18 })
    }
  );
  const dialog = open && (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: overlayStyle, role: "presentation", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: dialogStyle, role: "dialog", "aria-modal": "true", "aria-label": label, children: [
      ...
      phase.kind === "pending" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10 }, role: "status", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SpinnerGlyph, { size: 18 }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: titleStyle, children: t("restart.pending") }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: hintStyle, children: t("restart.pendingHint") })
        ] })
      ] }),
