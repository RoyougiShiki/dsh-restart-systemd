...
function RestartButton({ wide, t }) {
  ...
  const trigger = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "button",
    {
      ...
      "aria-label": label,
      "aria-busy": phase.kind === "busy" || void 0,
      ...
      children: phase.kind === "busy" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SpinnerGlyph, { size: wide ? 16 : 18 }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RestartGlyph, { size: wide ? 16 : 18 })
    }
  );
