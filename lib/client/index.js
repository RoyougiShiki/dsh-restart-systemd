...
var successStyle = { margin: "4px 0 0", color: "var(--dsw-alias-state-success-primary, #3fb950)" };
...
function RestartButton({ wide, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    open && (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: overlayStyle, role: "presentation", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: dialogStyle, role: "dialog", "aria-modal": "true", "aria-label": label, children: [
        ...
        phase.kind === "done" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: successStyle, children: t("restart.done") }),
...
function apply(ctx) {
  ...
  ctx.slots.inject(
    ...
    () => ctx.slots.register(
      ...
      (props) => (0, import_react2.createElement)(RestartButton, { wide: props.wide ?? true, t: props.t })
    )
  );
}
