...
function RestartButton({ wide, t }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const onCancel = (e) => { e.preventDefault(); e.stopPropagation(); close(); };
    const onProceed = (e) => { e.preventDefault(); e.stopPropagation(); confirm(); };
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: dialogStyle, role: "dialog", "aria-modal": "true", "aria-label": label, children: [
      phase.kind === "confirming" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: actionsStyle, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { ref: cancelRef, type: "button", style: cancelStyle, onClick: close, children: t("restart.cancel") }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { ref: proceedRef, type: "button", style: proceedStyle, onClick: confirm, children: t("restart.proceed") })
        ] })
      ] }),
