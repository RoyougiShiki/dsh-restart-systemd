...
export function RestartButton({ wide, t }) {
    ...
    useEffect(() => {
        if (document.getElementById('dsh-restart-css'))
            return;
    ...
    const dialog = open && createPortal((_jsxs("div", { style: overlayStyle, role: "presentation", children: [_jsx("div", { style: maskStyle, "aria-hidden": "true", onClick: close }), _jsxs("div", { style: dialogStyle, role: "dialog", "aria-modal": "true", "aria-label": label, children: [phase.kind === 'confirming' && (_jsxs(_Fragment, { children: [_jsx("p", { style: titleStyle, children: t('restart.confirm.title') }), _jsx("p", { style: bodyStyle, children: t('restart.confirm.body') }), _jsxs("div", { style: actionsStyle, children: [_jsx("button", { type: "button", style: cancelStyle, onClick: close, children: t('restart.cancel') }), _jsx("button", { type: "button", style: proceedStyle, onClick: confirm, children: t('restart.proceed') })] })] })), phase.kind === 'busy' && (_jsx("p", { style: titleStyle, children: t('restart.busy') })), phase.kind === 'done' && (_jsxs("div", { style: successCardStyle, role: "status", children: [_jsx(CheckGlyph, { size: 18 }), _jsxs("div", { children: [_jsx("p", { style: successTitleStyle, children: t('restart.done') }), _jsx("p", { style: successSubStyle, children: "DeepSeek Harness" })] })] })), phase.kind === 'denied' && (_jsx("p", { style: errorStyle, children: t('restart.denied') })), phase.kind === 'failed' && (_jsxs(_Fragment, { children: [_jsx("p", { style: errorStyle, children: phase.message }), _jsx("p", { style: hintStyle, children: t('restart.failedHint') })] }))] })] })), document.body);
